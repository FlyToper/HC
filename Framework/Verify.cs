...
namespace 基于云的Web管理系统.Framework
{
    public class Verify
    {
        protected Dictionary<string, string> config  = new Dictionary<string,string>
        {
            ...
            {"codeSet","2345678abcdefhijkmnpqrstuvwxyzABCDEFGHJKLMNPQRTUVWXY"},//验证码字符集
            {"expire", "1800"},//验证码过期时间
            {"useZh", "false"},//使用中文验证码
        ...
        private string _image = null;//验证码图片实例
        private string _color = null;//验证码字体颜色

        public Verify(Dictionary<string, string> config) {
            this.config = config;
        }
